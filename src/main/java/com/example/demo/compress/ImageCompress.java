package com.example.demo.compress;
...
public class ImageCompress {
    ...
    public static void main(String[] args) throws IOException {
       ...
       /* thumbnailatorTest.test1();
        ...
        thumbnailatorTest.batchSize("E:\\迅雷下载\\sharepdf\\images\\","E:\\迅雷下载\\sharepdf\\compressImages\\");
    }
    
    
    private void batchSize(String sourceDir, String targetDir) throws IOException {
    	 File directory = new File(sourceDir);
 	    if (!directory.exists()) {
 	      System.err.println("路径[" + sourceDir + "]文件夹不存在!");
 	      return;
 	    }
 	    File[] listFiles = directory.listFiles();
 	    for (File file : listFiles) {
 	    	Thumbnails.of(file).size(700, 1000).toFile(targetDir+file.getName());
 	    }
    }
